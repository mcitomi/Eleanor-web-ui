...
export default () => {
    return (
        <Container className="mx-auto text-center">
            <span><span className="h1">About the Eleanor Project</span></span>
                ...
                <Col className="d-flex justify-content-center align-items-center">
                    <Card style={{ width: '18rem', marginTop: "10%" }}>
                        ...
                        <Card.Body>
                            ...
                            <Button href="https://github.com/rektdie/Eleanor" target="_blank" variant="primary">Go to GitHub</Button>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col className="d-flex justify-content-center align-items-center">
                    <Card style={{ width: '18rem', marginTop: "10%" }}>
                        ...
                        <Card.Body>
                            ...
                            <Button href="https://github.com/mcitomi/Eleanor-web-ui" target="_blank" variant="primary">Go to GitHub</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
