                ...
                <Col className="d-flex justify-content-center align-items-center">
                    <Card style={{ width: '18rem', marginTop: "10%" }}>
                        ...
                        <Card.Body>
                            ...
                            <Button href="https://github.com/rektdie/Eleanor" target="_blank" variant="dark">Go to GitHub</Button>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col className="d-flex justify-content-center align-items-center">
                    <Card style={{ width: '18rem', marginTop: "10%" }}>
                        ...
                        <Card.Body>
                            ...
                            <Button href="https://github.com/mcitomi/Eleanor-web-ui" target="_blank" variant="dark">Go to GitHub</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
